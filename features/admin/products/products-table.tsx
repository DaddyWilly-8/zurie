          ...
          <Table sx={{ minWidth: 860 }}>
            <TableHead>
              <TableRow sx={{ bgcolor: "action.hover" }}>
                <TableCell sx={{ whiteSpace: "nowrap", letterSpacing: "0.24em", fontSize: "0.68rem", color: "text.secondary", fontWeight: 600 }}>Product</TableCell>
                <TableCell sx={{ whiteSpace: "nowrap", letterSpacing: "0.24em", fontSize: "0.68rem", color: "text.secondary", fontWeight: 600 }}>Category</TableCell>
                <TableCell sx={{ whiteSpace: "nowrap", letterSpacing: "0.24em", fontSize: "0.68rem", color: "text.secondary", fontWeight: 600 }}>Price</TableCell>
                <TableCell sx={{ whiteSpace: "nowrap", letterSpacing: "0.24em", fontSize: "0.68rem", color: "text.secondary", fontWeight: 600 }}>Stock</TableCell>
                <TableCell sx={{ whiteSpace: "nowrap", letterSpacing: "0.24em", fontSize: "0.68rem", color: "text.secondary", fontWeight: 600 }}>Flags</TableCell>
                <TableCell align="right" sx={{ whiteSpace: "nowrap", letterSpacing: "0.24em", fontSize: "0.68rem", color: "text.secondary", fontWeight: 600 }}>Actions</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {products.map((item) => (
