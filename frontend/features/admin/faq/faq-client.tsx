              ...
              <Stack spacing={1.5}>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  <TextField
                    ...
                    onChange={(e) =>
                      setNewDisplayOrder(parseInteger(e.target.value))
                    }
                    sx={{
                      width: 180,
                      bgcolor: "background.paper",
                      ...
                      {isEditing ? (
                        <Stack spacing={1.5}>
                          <AdminField
                            ...
                            value={faq.question}
                            onChange={(value) =>
                              handleEditChange(faq.id, "question", value)
                            }
                          />
                          <AdminField
                            label="Answer"
                            value={faq.answer}
                            onChange={(value) =>
                              handleEditChange(faq.id, "answer", value)
                            }
                            multiline
                            minRows={2}
                          />
                          ...
                          >
                            ...
                            <AdminToggle
                              ...
                              checked={faq.visible}
                              onChange={(checked) =>
                                handleEditChange(faq.id, "visible", checked)
                              }
                            />
                          </Stack>
                          <Stack direction="row" spacing={1}>
                          ...
                          >
                            ...
                            >
                              <IconButton
                                size="small"
                                onClick={() =>
                                  toggleVisibility(faq.id, faq.visible)
                                }
                                sx={{
                                  color: faq.visible
                                    ? "text.secondary"
