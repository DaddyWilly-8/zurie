...
export default function AboutPage() {
  ...
  const aboutStory = `${brand.siteName} was founded to create handbags that blend timeless design, premium materials, and everyday functionality.`;
        ...
        <Container maxWidth="lg">
          <Grid container spacing={{ xs: 3, md: 5 }} alignItems="center">
            ...
            >
              ...
              >
                {`At ${brand.siteName}, we believe that true luxury lies in the details. Every curve, stitch, and material is chosen with intention, creating pieces that are not just accessories, but extensions of self.`}
              </Typography>
            </Grid>
          </Grid>
        </Container>
